...
\subsection{Simple Java Simulator}
 \begin{figure}[h]
 \label{fig:simulator_java}
 \centering
  \includegraphics[width=0.5 \textwidth]{images/simulator/SimpleJavaSimulator.png}
...
\subsection{MatSim}
Matsim showed in Figure \ref{fig:simulator_matsim} is a powerful simulator which you can see from its simulated traffic networks.
 \begin{figure}[h]
 \label{fig:simulator_matsim}
 \centering
  \includegraphics[width=0.5\textwidth]{images/simulator/matsim_zurich.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.5\textwidth]{images/simulator/caltrain.png}
