...
\begin{abstract}
Traffic Flow maximization is one of the crucial problems in designing a city. It directly affects the daily life of the people living in that city. As it is a complex problem and there is not any existing deterministic algorithm can solve it perfectly. We propose using evolutionary algorithm to solve that problem. By comparing the previous work with what we did in this paper, we can easily conclue that it is beneficial to adopt evolutionary algorithm while we are designing the trafffic lights. 
\end{abstract}
